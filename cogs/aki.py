...
class Akinator(commands.Cog):
    ...
    async def akinator(self,ctx):
        intro=discord.Embed(title="Akinator",description="Hello, "+ctx.author.mention+"I am Akinator Invited by Tessarect!!!",color=discord.Colour.blue())
        ...
        bye=discord.Embed(title="Akinator",description="I gotta go there may be someone waiting for me bye bye !, "+ctx.author.mention,color=discord.Colour.blue())
